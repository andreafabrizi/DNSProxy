...
### Examples for DNS-over-HTTP beginners:
...
This old example dialog shows that a correct negotiation does not happen and an
insecure URI is being used, a pre-DoH prototype: http://www.fantuz.net/nslookup-doh.php.
```
